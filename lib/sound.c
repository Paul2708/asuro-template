...
/*!
  ...
  Mit den Motoren des ASUROs lassen sich auch T�ne erzeugen.\n
  Das Prinzip dahinter ist folgendes:\n
  Die Frequenz des Tons wird durch umschalten der Motor Drehrichtung bestimmt.\n
  Die Lautst�rke wird �ber die Geschwindigkeit der Motoren bestimmt.\n
  Theoretisch liessen sich damit auch Stereo Signale erzeugen, da es ja zwei\n
  Motoren gibt, die sich auch getrennt ansteuern lassen. Dazu m�sste die\n
...
/*!
  ...
  \code
  // Laesst den Asuro einen Ton von 1kHz f�r eine 1/2 Sekunde
